...
% this is the function that turns the illuminated complex sample into the low-resolution image that the simulated camera would measure.
% illuminated object
%      ↓
%Fourier transform
%      ↓
%apply objective pupil / low-pass filter
%      ↓
